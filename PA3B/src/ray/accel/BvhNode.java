...
public class BvhNode {
	 ...
	 * @param right
	 */
	public BvhNode(Point3 minBound, Point3 maxBound, BvhNode leftChild, BvhNode rightChild, int left, int right) 
	{
		...
		this.surfaceIndexStart = left;
		this.surfaceIndexEnd = right;
	}
