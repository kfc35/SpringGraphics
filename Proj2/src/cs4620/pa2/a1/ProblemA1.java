...
/**
 * Main window of Problem 1 of PA2A.
 *
...
public class ProblemA1 extends JFrame implements GLSceneDrawer,
...

{
	...
	public ProblemA1() {
		super("CS 4620/5620 Programming Assignment 2A / Problem 1");
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if (cmd.equals(SHADER_COMBO_BOX_COMMAND))
		{
			...
			if(nodes[0] instanceof MeshNode)
			{
				...
				GLPhongMaterial newLightableMaterial = null;
				
				if(selectedShader.equals(GL_BLINN_PHONG_TEXT) && (!(meshMaterial instanceof GLPhongMaterial) || (meshMaterial instanceof ShaderPhongMaterial) || (meshMaterial instanceof ShaderToonMaterial)))
				{
					//System.out.println("Selected " + GL_BLINN_PHONG_TEXT);
					newLightableMaterial = new GLPhongMaterial();
				...
				else if(selectedShader.equals(BLINN_PHONG_TEXT) && !(meshMaterial instanceof ShaderPhongMaterial))
				{
					...
					newLightableMaterial = new ShaderPhongMaterial();
					meshNode.setMaterial(newLightableMaterial);
					changedMaterial = true;
				}
				else if(selectedShader.equals(TOON_SHADER_TEXT) && !(meshMaterial instanceof ShaderToonMaterial))
				{
					...
					newLightableMaterial = new ShaderToonMaterial();
					meshNode.setMaterial(newLightableMaterial);
					changedMaterial = true;
				}
				...
				if(changedMaterial)
				{
					if(meshMaterial instanceof GLPhongMaterial && newLightableMaterial != null)
					{
						// copy over material settings
						GLPhongMaterial old = (GLPhongMaterial) meshMaterial;
